...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 318.0, 283.250000533546427, 170.833298325538635, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1186.362866860420127, 15.0, 169.0, 72.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 799.833298325538635, 20.833346179382261, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.362866860420127, 204.333333492279053, 100.0, 20.0 ],
					"text" : "debug view",
					"texton" : "debug view"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 799.833298325538635, 55.348018865612516, 77.0, 22.0 ],
					"text" : "clientwindow"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 63.0, -4.00000011920929, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1401.333375096321106, 1004.000029921531677, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "components (unused)",
					"id" : "obj-15",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.666681289672852, -13.333333730697632, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "(bang) pulse (unused)",
					"id" : "obj-14",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 63.0, -84.666667342185974, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.0, 20.833346179382261, 76.833298325538635, 49.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 672.0, 518.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 648.0, 408.0, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 538.0, 256.0, 24.0, 24.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 827.725829624713697, 4.333333492279053, 540.0, 228.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 167.66661274433136, -9.666667938232422, 53.0, 22.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.66661274433136, -89.333333253860474, 30.0, 30.0 ]
				}
